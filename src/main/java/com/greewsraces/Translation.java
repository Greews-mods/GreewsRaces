...
public class Translation {
    ...
    static {
        ...
        cs.put("race.wood_elf.bonus", "+20% poškození s lukem\n+10% rychlost pohybu");
        ...
        en.put("race.wood_elf.bonus", "+20% damage with bow\n+10% movement speed");
        ...
        es.put("race.wood_elf.bonus", "+20% de daño con arco\n+10% velocidad de movimiento");
        ...
        ru.put("race.wood_elf.bonus", "+20% урона луком\n+10% скорость движения");
