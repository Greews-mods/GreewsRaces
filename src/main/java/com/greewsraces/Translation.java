...
public class Translation {
    ...
    static {
        ...
        fr.put("select_race", "Choisissez votre race");
        fr.put("select_language", "Choisir la langue");
        fr.put("select", "Choisir");
        fr.put("bonuses", "Bonus :");
        fr.put("maluses", "Malus :");
        fr.put("race.human", "Humain");
        fr.put("race.human.desc", "Guerrier polyvalent");
        fr.put("race.human.bonus", "+20 % de dégâts à l'épée");
        fr.put("race.human.malus", "Aucun malus spécifique");
        fr.put("race.dwarf", "Nain");
        fr.put("race.dwarf.desc", "Maître de la hache et des profondeurs");
        fr.put("race.dwarf.bonus", "+20 % dégâts hache\n+20 % vitesse de minage\n+2 armure\n+20 % portée");
        fr.put("race.dwarf.malus", "-20 % dégâts épée\n-20 % dégâts arc\n-10 % vitesse\n-20 % taille");
        fr.put("race.night_elf", "Elfe de la nuit");
        fr.put("race.night_elf.desc", "Archer des ombres");
        fr.put("race.night_elf.bonus", "+20 % dégâts arbalète\n+20 % vitesse la nuit");
        fr.put("race.night_elf.malus", "-20 % dégâts hache\n-20 % dégâts arc\n+20 % taille");
        fr.put("race.wood_elf", "Elfe des bois");
        fr.put("race.wood_elf.desc", "Maître de l'arc et de la forêt");
        fr.put("race.wood_elf.bonus", "+20 % PV\n+20 % dégâts arc\n+10 % vitesse");
        fr.put("race.wood_elf.malus", "-20 % dégâts hache\n+20 % taille");
        fr.put("race.demon", "Démon");
        fr.put("race.demon.desc", "Seigneur du feu et de la destruction");
        fr.put("race.demon.bonus", "+20 % dégâts épée\nImmunité feu et lave");
        fr.put("race.demon.malus", "-20 % dégâts arc\n-20 % dégâts arbalète\nDégâts eau/pluie");
        fr.put("race.vampire", "Vampire");
        fr.put("race.vampire.desc", "Chasseur de sang immortel");
        fr.put("race.vampire.bonus", "+20 % dégâts toutes armes\n30 % vol de vie");
        fr.put("race.vampire.malus", "Brûle au soleil");
        fr.put("race.ghoul", "Goule");
        fr.put("race.ghoul.desc", "Créature des ténèbres et de la pourriture");
        fr.put("race.ghoul.bonus", "Respire sous l'eau\nChair pourrie le nourrit\nNe brûle pas au soleil");
        fr.put("race.ghoul.malus", "Ne mange que la viande crue");
        fr.put("race.fairy", "Fée");
        fr.put("race.fairy.desc", "Créature légère de la nature");
        fr.put("race.fairy.bonus", "+10 % vitesse\n+20 % dégâts trident\n+50 % armure cuir\n+20 % portée");
        fr.put("race.fairy.malus", "-30 % taille\n-20 % dégâts hache\n-20 % dégâts pioche");
        translations.put("fr", fr);

        // ==================== PORTUGUÊS ====================
        Map<String, String> pt = new HashMap<>();
        pt.put("select_race", "Escolha sua raça");
        pt.put("select_language", "Selecionar idioma");
        pt.put("select", "Selecionar");
        pt.put("bonuses", "Bônus:");
        pt.put("maluses", "Penalidades:");
        pt.put("race.human", "Humano");
        pt.put("race.human.desc", "Guerreiro versátil");
        pt.put("race.human.bonus", "+20% dano com espada");
        pt.put("race.human.malus", "Sem penalidades específicas");
        pt.put("race.dwarf", "Anão");
        pt.put("race.dwarf.desc", "Mestre do machado e do subterrâneo");
        pt.put("race.dwarf.bonus", "+20% dano machado\n+20% mineração\n+2 armadura\n+20% alcance");
        pt.put("race.dwarf.malus", "-20% dano espada\n-20% dano arco\n-10% velocidade\n-20% altura");
        pt.put("race.night_elf", "Elfo da Noite");
        pt.put("race.night_elf.desc", "Arqueiro das sombras");
        pt.put("race.night_elf.bonus", "+20% dano besta\n+20% velocidade à noite");
        pt.put("race.night_elf.malus", "-20% dano machado\n-20% dano arco\n+20% altura");
        pt.put("race.wood_elf", "Elfo da Floresta");
        pt.put("race.wood_elf.desc", "Mestre do arco e da floresta");
        pt.put("race.wood_elf.bonus", "+20% HP\n+20% dano arco\n+10% velocidade");
        pt.put("race.wood_elf.malus", "-20% dano machado\n+20% altura");
        pt.put("race.demon", "Demônio");
        pt.put("race.demon.desc", "Senhor do fogo e da destruição");
        pt.put("race.demon.bonus", "+20% dano espada\nImune a fogo e lava");
        pt.put("race.demon.malus", "-20% dano arco\n-20% dano besta\nDano de água/chuva");
        pt.put("race.vampire", "Vampiro");
        pt.put("race.vampire.desc", "Caçador de sangue imortal");
        pt.put("race.vampire.bonus", "+20% dano com todas armas\n30% roubo de vida");
        pt.put("race.vampire.malus", "Queima ao sol");
        pt.put("race.ghoul", "Ghoul");
        pt.put("race.ghoul.desc", "Criatura das trevas e da podridão");
        pt.put("race.ghoul.bonus", "Respira debaixo d'água\nCarne podre alimenta\nNão queima ao sol");
        pt.put("race.ghoul.malus", "Só come carne crua");
        pt.put("race.fairy", "Fada");
        pt.put("race.fairy.desc", "Criatura leve da natureza");
        pt.put("race.fairy.bonus", "+10% velocidade\n+20% dano tridente\n+50% armadura de couro\n+20% alcance");
        pt.put("race.fairy.malus", "-30% altura\n-20% dano machado\n-20% dano picareta");
        translations.put("pt", pt);

        // ==================== TÜRKÇE ====================
        Map<String, String> tr = new HashMap<>();
        tr.put("select_race", "Irkınızı seçin");
        tr.put("select_language", "Dil seçin");
        tr.put("select", "Seç");
        tr.put("bonuses", "Bonuslar:");
        tr.put("maluses", "Dezavantajlar:");
        tr.put("race.human", "İnsan");
        tr.put("race.human.desc", "Çok yönlü savaşçı");
        tr.put("race.human.bonus", "Kılıçla +%20 hasar");
        tr.put("race.human.malus", "Belirli bir dezavantaj yok");
        tr.put("race.dwarf", "Cüce");
        tr.put("race.dwarf.desc", "Balta ve yeraltının ustası");
        tr.put("race.dwarf.bonus", "Balta +%20 hasar\n+%20 madencilik\n+2 zırh\n+%20 menzil");
        tr.put("race.dwarf.malus", "Kılıç -%20\nYay -%20\nHız -%10\nBoy -%20");
        tr.put("race.night_elf", "Gece Elf");
        tr.put("race.night_elf.desc", "Gölge okçusu");
        tr.put("race.night_elf.bonus", "Arbalet +%20\nGece hız +%20");
        tr.put("race.night_elf.malus", "Balta -%20\nYay -%20\nBoy +%20");
        tr.put("race.wood_elf", "Orman Elf");
        tr.put("race.wood_elf.desc", "Yay ve orman ustası");
        tr.put("race.wood_elf.bonus", "+%20 HP\nYay +%20 hasar\nHız +%10");
        tr.put("race.wood_elf.malus", "Balta -%20\nBoy +%20");
        tr.put("race.demon", "İblis");
        tr.put("race.demon.desc", "Ateş ve yıkımın efendisi");
        tr.put("race.demon.bonus", "Kılıç +%20\nAteş/lav bağışıklığı");
        tr.put("race.demon.malus", "Yay -%20\nArbalet -%20\nSu/yağmur hasarı");
        tr.put("race.vampire", "Vampir");
        tr.put("race.vampire.desc", "Ölümsüz kan avcısı");
        tr.put("race.vampire.bonus", "Tüm silahlar +%20\n30% can çalma");
        tr.put("race.vampire.malus", "Güneşte yanar");
        tr.put("race.ghoul", "Gul");
        tr.put("race.ghoul.desc", "Karanlık ve çürümenin yaratığı");
        tr.put("race.ghoul.bonus", "Suda nefes alır\nÇürük et besler\nGüneşte yanmaz");
        tr.put("race.ghoul.malus", "Sadece çiğ et yer");
        tr.put("race.fairy", "Peri");
        tr.put("race.fairy.desc", "Doğanın hafif yaratığı");
        tr.put("race.fairy.bonus", "Hız +%10\nMızrak +%20\nDeri zırh +%50\nMenzil +%20");
        tr.put("race.fairy.malus", "Boy -%30\nBalta -%20\nKazma -%20");
